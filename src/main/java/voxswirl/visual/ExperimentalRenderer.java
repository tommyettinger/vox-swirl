...
public class ExperimentalRenderer {
    ...
    protected ExperimentalRenderer() {

    }
    public ExperimentalRenderer(final int size) {
        this(size, 24);
    }
    public ExperimentalRenderer(final int size, final int quality) {
        this.size = size;
...
//        return (PaletteReducer.TRI_BLUE_NOISE[(x + v * 5 & 63) | (y + v * 3 & 63) << 6] + 0.5f) * 0x3p-9f;
     ...
     */
    public ExperimentalRenderer saturation(float saturationModifier) {
    ...
    public ExperimentalRenderer palette(PaletteReducer color) {
        return palette(color.paletteArray);
    }

    public ExperimentalRenderer palette(int[] color) {
        this.palette = color;
...
//        }
    ...
    public ExperimentalRenderer clear() {
        pixmap.setColor(0);
        pixmap.fill();
        fill(depths, 0);
        fill(render, 0);
